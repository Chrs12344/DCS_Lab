...
public class Exercise1 {
    public static TwoXTwoTable createInversor() {
        ...
        // FLRS table with two inputs and two outputs
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String inputLine="";
            System.out.println("Give weights w1 and w2, with space between them: ");
            ...
            System.out.println("Give inputs x1 and  x2 with space between them:  ");
            inputLine = in.readLine();
