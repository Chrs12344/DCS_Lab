    ...
    try{
      ...
      while(!line.equals("END")){
        ...
        try {
          ...
          System.out.println("Server a receptionat:" + x + " " + y);

          // Send the computations to the client
          float result = (float) y / (x * 100);
          out.println("(" + y + " / " + x + " * " + "100) = " + result); //trimite date la client
          out.flush();
